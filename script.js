...
const translations = {
    en: {
        ...
        projStatusDesc: "Monitors all my services and shows if something goes down. Checks every 30 seconds.",
        projStatusDesc: "Monitors all my services and shows if something goes down. Checks every 30 seconds.",
    ...
    es: {
        ...
        projStatusDesc: "Vigila todos mis servicios y avisa si algo cae. Comprueba cada 30 segundos.",
    ...
    ca: {
        ...
        projStatusDesc: "Vigila tots els meus serveis i avisa si alguna cosa cau. Comprova cada 30 segons.",
